/*
  ...
  * Created        : Thu Nov 27 16:45:59 2014
  * Standard       : ANSI C
...
/* definitions for register: 1-PPS delay register */

/* definitions for field: Tap value for IODelay in reg: 1-PPS delay register */
#define PPSG_DELAY_TAP_SET_MASK               WBGEN2_GEN_MASK(0, 5)
#define PPSG_DELAY_TAP_SET_SHIFT              0
#define PPSG_DELAY_TAP_SET_W(value)           WBGEN2_GEN_WRITE(value, 0, 5)
#define PPSG_DELAY_TAP_SET_R(reg)             WBGEN2_GEN_READ(reg, 0, 5)

/* definitions for field: Tap value read from IODelay in reg: 1-PPS delay register */
#define PPSG_DELAY_TAP_CUR_MASK               WBGEN2_GEN_MASK(8, 5)
#define PPSG_DELAY_TAP_CUR_SHIFT              8
#define PPSG_DELAY_TAP_CUR_W(value)           WBGEN2_GEN_WRITE(value, 8, 5)
#define PPSG_DELAY_TAP_CUR_R(reg)             WBGEN2_GEN_READ(reg, 8, 5)
