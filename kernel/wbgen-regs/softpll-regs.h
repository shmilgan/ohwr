/*
  ...
  * Created        : Wed Mar 25 14:51:14 2015
  * Standard       : ANSI C
...
/* definitions for register: Port state register (direct access) */

/* definitions for field: States in reg: Port state register (direct access) */
#define SPLL_PSR_STATES_MASK                  WBGEN2_GEN_MASK(0, 32)
#define SPLL_PSR_STATES_SHIFT                 0
#define SPLL_PSR_STATES_W(value)              WBGEN2_GEN_WRITE(value, 0, 32)
#define SPLL_PSR_STATES_R(reg)                WBGEN2_GEN_READ(reg, 0, 32)

/* definitions for register: PTP support unit (direct notification) */

/* definitions for field: Holdover State in reg: PTP support unit (direct notification) */
#define SPLL_PSU_HOLDOVER                     WBGEN2_GEN_MASK(0, 1)

/* definitions for field: Received Announce with Holdover clock Class, write 1 to clear in reg: PTP support unit (direct notification) */
#define SPLL_PSU_RX_HOLDOVER_MSG              WBGEN2_GEN_MASK(1, 1)

/* definitions for field: Mask which indicates which reference input is used (i.e. active slave port) in reg: PTP support unit (direct notification) */
#define SPLL_PSU_SELECTED_REF_ID_MASK         WBGEN2_GEN_MASK(8, 5)
#define SPLL_PSU_SELECTED_REF_ID_SHIFT        8
#define SPLL_PSU_SELECTED_REF_ID_W(value)     WBGEN2_GEN_WRITE(value, 8, 5)
#define SPLL_PSU_SELECTED_REF_ID_R(reg)       WBGEN2_GEN_READ(reg, 8, 5)
...
PACKED struct SPLL_WB {
  ...
  uint32_t DFR_SPLL;
  /* [0x50]: REG Port state register (direct access) */
  uint32_t PSR;
  /* [0x54]: REG PTP support unit (direct notification) */
  uint32_t PSU;
  /* padding to: 24 words */
