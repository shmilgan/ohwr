************************************************************************
ieee8021BridgeTrafficClassTable README
------------------------------------------------------------------------
  ...
  the ieee8021BridgeTrafficClassTable table.  The agent will start by looking for the right
  ...
  file defaults/table-ieee8021BridgeTrafficClassTable.m2d, and then re-running mib2c.
    ...
    in the ieee8021BridgeTrafficClassTable.h header.
 ...
 Index(es) for the ieee8021BridgeTrafficClassTable table
  ------------------------------------------------------------
  The index(es) for the ieee8021BridgeTrafficClassTable table are:
...
************************************************************************
ieee8021BridgeTrafficClassTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the ieee8021BridgeTrafficClassTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: ieee8021BridgeTrafficClassTable_data_access.[c|h]
------------------------------------------------------------------------
  The ieee8021BridgeTrafficClassTable_data_access file contains the interface to your data in
  ...
  FUNC : ieee8021BridgeTrafficClassTable_indexes_set
  WHERE: ieee8021BridgeTrafficClassTable_data_access.c
...
File: ieee8021BridgeTrafficClassTable_enums.h
------------------------------------------------------------------------
...
File: ieee8021BridgeTrafficClassTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : ieee8021BridgeTrafficClass_get



File: ieee8021BridgeTrafficClassTable_data_set.c
------------------------------------------------------------------------
  ...
  Set $m2c_table_dependencies = 0 in defaults/table-ieee8021BridgeTrafficClassTable.m2d
  ...
  FUNC : ieee8021BridgeTrafficClassTable_check_dependencies
  ...
  FUNC : ieee8021BridgeTrafficClassTable_undo_setup
  ...
  FUNC : ieee8021BridgeTrafficClass_check_value
  ...
  FUNC : ieee8021BridgeTrafficClass_undo_setup
  ...
  FUNC : ieee8021BridgeTrafficClass_set
  ...
  FUNC : ieee8021BridgeTrafficClass_undo
  ...
  --------------
  TODO : commit changes
  FUNC : ieee8021BridgeTrafficClassTable_commit
...
************************************************************************
ieee8021BridgeTrafficClassTable Reference
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      ieee8021BridgeTrafficClassTable table.

      Conversely, the examples below may not include some functions that
      were generated for the ieee8021BridgeTrafficClassTable table.

To watch the flow of the ieee8021BridgeTrafficClassTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        ieee8021BridgeTrafficClassTable
        verbose:ieee8021BridgeTrafficClassTable
        internal:ieee8021BridgeTrafficClassTable

e.g.
        snmpd -f -Le -Dieee8021BridgeTrafficClassTable,verbose:ieee8021BridgeTrafficClassTable,internal:ieee8021BridgeTrafficClassTable
...
/*---------------------------------------------------------------------
 * IEEE8021-BRIDGE-MIB::ieee8021BridgeTrafficClassEntry.ieee8021BridgeTrafficClassPriority
 * ieee8021BridgeTrafficClassPriority is subid 1 of ieee8021BridgeTrafficClassEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.111.2.802.1.1.2.1.3.3.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE ieee8021BridgeTrafficClassPriority IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
