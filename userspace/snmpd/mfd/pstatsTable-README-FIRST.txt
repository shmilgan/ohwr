...
begin with the pstatsTable prefix.
...
------------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f pstatsTable_Makefile


  File    : pstatsTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   pstatsTable-README-pstatsTable.txt
