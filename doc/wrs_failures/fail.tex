...
\subsubsection{\bf \emph{PTP/PPSi} went out of \texttt{TRACK\_PHASE}}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPtpServoState.<n>}} -- PTP servo state as string\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPtpServoStateN.<n>}} -- PTP servo state as number\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPtpServoStateErrCnt}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPTPStatus}}
...
\subsubsection{\bf Offset jump not compensated by Slave}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPtpClockOffsetPs.<n>}} -- value of the offset in ps\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPtpClockOffsetPsHR.<n>}} -- 32-bit signed value of the offset in ps; with
				saturation on overflow and underflow\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPtpClockOffsetErrCnt}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPTPStatus}}
		\end{packed_enum}
...
\subsubsection{\bf Detected jump in the RTT value calculated by \emph{PTP/PPSi}}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPtpRTT.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPtpRTTErrCnt}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPTPStatus}}
		\end{packed_enum}
...
\subsubsection{\bf Wrong $\Delta_{TXM}$, $\Delta_{RXM}$, $\Delta_{TXS}$,
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPtpDeltaTxM.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPtpDeltaRxM.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPtpDeltaTxS.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPtpDeltaRxS.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPTPStatus}}
		\end{packed_enum}
...
\subsubsection{\bf \emph{SoftPLL} became unlocked}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsSpllMode}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsSpllSeqState}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsSpllAlignState}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsSpllHlock}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsSpllMlock}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsSpllDelCnt}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsSoftPLLStatus}}
		\end{packed_enum}
...
\subsubsection{\bf \emph{SoftPLL} has crashed/restarted}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsSpllIrqCnt}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntSPLL}} \emph{(not yet implemented)}
...
\subsubsection{\bf Link to WR Master is down for slave}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusLink.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusConfiguredMode.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsSlaveLinksStatus}}
		\end{packed_enum}
...
\subsubsection{\bf PTP frames don't reach ARM}
		...
		\begin{packed_enum}
			...
			\item [] \underline{Description}:\\
				...
				\end{itemize}
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusPtpTxFrames.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusPtpRxFrames.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusLink.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusConfiguredMode.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPTPFramesFlowing}}
...
\subsubsection{\bf Detected SFP not supported for WR timing}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusConfiguredMode.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusSfpVN.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusSfpPN.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusSfpVS.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusSfpInDB.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusSfpGbE.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusSfpError.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsSFPsStatus}}
...
\subsubsection{\bf \emph{PTP/PPSi} process has crashed/restarted}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntPTP}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootUserspaceDaemonsMissing}}\\
				\texttt{\gls{HOST-RESOURCES-MIB::hrSWRunName.<n>}}
		\end{packed_enum}
...
\subsubsection{\bf \emph{HAL} process has crashed/restarted}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntHAL}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootUserspaceDaemonsMissing}}\\
				\texttt{\gls{HOST-RESOURCES-MIB::hrSWRunName.<n>}}
		\end{packed_enum}
...
\subsubsection{\bf Link down}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{IF-MIB::ifOperStatus.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusLink.<n>}}
		\end{packed_enum}
...
\subsubsection{\bf Fault in the Endpoint's transmission/reception path}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsTXUnderrun.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXOverrun.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXInvalidCode.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXSyncLost.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXPfilterDropped.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXPCSErrors.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXCRCErrors.<n>}}
		\end{packed_enum}
...
\subsubsection{\bf Problem with the SwCore or Endpoint HDL module}
    ...
    \item [] \underline{Status}: TODO (add monitoring of the Endpoint hangs, depend on
      HDL)
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsGwWatchdogTimeouts}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsTXFrames.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsForwarded.<n>}}
...
\subsubsection{\bf RTU is full and cannot accept more requests}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXDropRTUFull.<n>}}
		\end{packed_enum}
...
\subsubsection{\bf Too much HP traffic / Per-priority queue full}
		...
		\begin{packed_enum}
			...
			\item [] \underline{Description}:\\
				...
				unacceptable.
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsFastMatchPriority.<n>}} - HP frames on a port\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXFrames<n>}} - Total number of Rx frames on
				the port\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXPrio0.<n>}} - Rx priorities 0-7\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXPrio1.<n>}} \\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXPrio2.<n>}} \\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXPrio3.<n>}} \\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXPrio4.<n>}} \\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXPrio5.<n>}} \\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXPrio6.<n>}} \\
				\texttt{\gls{WR-SWITCH-MIB::wrsPstatsRXPrio7.<n>}}
...
\subsubsection{\bf \emph{RTUd} has crashed}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntRTUd}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootUserspaceDaemonsMissing}}\\
				\texttt{\gls{HOST-RESOURCES-MIB::hrSWRunName.<n>}}
		\end{packed_enum}
...
\subsubsection{\bf WR Switch did not boot correctly}
		...
		\begin{packed_enum}
			...
			\item [] \underline{Description}:\\
				...
				\end{itemize}
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootSuccessful}} -- status word informing whether switch booted correctly\\
				\texttt{\gls{WR-SWITCH-MIB::wrsRestartReason}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsRestartReasonMonit}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsConfigSource}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsConfigSourceUrl}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootHwinfoReadout}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootLoadFPGA}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootLoadLM32}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootKernelModulesMissing}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootUserspaceDaemonsMissing}}
			\item [] \underline{Note}: 
...
\subsubsection{\bf Dot-config error}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootSuccessful}} -- status word informing
					whether switch booted correctly\\
				\texttt{\gls{WR-SWITCH-MIB::wrsConfigSource}} -- source of a dot-config,
				...
				\texttt{\gls{WR-SWITCH-MIB::wrsConfigSourceUrl}} -- path to the dot-config
					on a server (if not local)\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootConfigStatus}} -- result of the dot-config verification
		\end{packed_enum}
...
\subsubsection{\bf Any userspace daemon has crashed/restarted}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{HOST-RESOURCES-MIB::hrSWRunName.<n>}} - list of processes in standard MIB\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntHAL}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntPTP}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntRTUd}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntSshd}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntHttpd}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntSnmpd}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntSyslogd}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntWrsWatchdog}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsStartCntSPLL}} \emph{(not implemented)}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootUserspaceDaemonsMissing}} - number of missing processes\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootSuccessful}} - status word informing whether switch booted correctly
...
\subsubsection{\bf Kernel crash}
		\begin{packed_enum}
			...
			\item [] \underline{Description}:\\
				...
				the last reboot.
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsBootCnt}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsRebootCnt}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsRestartReason}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsFaultIP}} \emph{(not implemented)}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsFaultLR}} \emph{(not implemented)}
			\item [] \underline{Note}:
...
\subsubsection{\bf System nearly out of memory}
		...
		\begin{packed_enum}
			...
			\item [] \underline{Description}:\\
				...
				system running).
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsMemoryTotal}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsMemoryUsed}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsMemoryUsedPerc}} - percentage of used memory\\
				\texttt{\gls{WR-SWITCH-MIB::wrsMemoryFree}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsMemoryFreeLow}} - warning or error on low memory
		\end{packed_enum}
\subsubsection{\bf Disk space low}
		...
		\begin{packed_enum}
			...
			\item [] \underline{Description}:\\
				...
				system running).
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsDiskMountPath.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsDiskSize.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsDiskUsed.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsDiskFree.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsDiskUseRate.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsDiskFilesystem.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsDiskSpaceLow}} - warning or error on low disk space\\
				\texttt{\gls{HOST-RESOURCES-MIB::hrStorageDescr.<n>}}\\
				\texttt{\gls{HOST-RESOURCES-MIB::hrStorageSize.<n>}}\\
				\texttt{\gls{HOST-RESOURCES-MIB::hrStorageUsed.<n>}}
			\item [] \underline{Note}:
...
\subsubsection{\bf CPU load too high}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsCPULoadAvg1min}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsCPULoadAvg5min}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsCPULoadAvg15min}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsCpuLoadHigh}} - warning or error when CPU load too high
		\end{packed_enum}
...
\subsubsection{\bf Temperature inside the box too high}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				\texttt{\gls{WR-SWITCH-MIB::wrsTempFPGA}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsTempPLL}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsTempPSL}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsTempPSR}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsTempThresholdFPGA}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsTempThresholdPLL}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsTempThresholdPSL}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsTempThresholdPSR}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsTemperatureWarning}}
		\end{packed_enum}
...
\subsubsection{\bf Not supported SFP plugged into the cage (especially non 1-Gb SFP)}
		...
		\begin{packed_enum}
			...
			\item [] \underline{SNMP objects}:\\
				...
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusSfpGbE.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsPortStatusSfpError.<n>}}\\
				\texttt{\gls{WR-SWITCH-MIB::wrsSFPsStatus}} - status word for SFPs' status
		\end{packed_enum}
