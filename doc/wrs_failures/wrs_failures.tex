...
\title{White Rabbit Switch: Failures and Diagnostics\\[0.5cm]
%\large {what to report, how to recover}}
\Large {the very first draft}}
\author{Grzegorz Daniluk CERN BE-CO-HT\\ Adam Wujek CERN BE-CO-HT}
\maketitle
\thispagestyle{empty}
